...
This project has demonstrated the verification of a register allocator in a modular, extensible way. Although the resulting algorithm lacks several features of more advanced register allocators, it works effectively on the graphs tested and has proven behaviour. Chapter~\ref{sec:extensions} demonstrates how it can be extended in various ways without much extra work, and as discussed above the performance of critical functions could be improved relatively easily.
