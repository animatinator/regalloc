...
A consequence of the last theorem is that evaluating \texttt{get\_conflicts} on an unused register will yield the empty list, a property which allows us to specify definitions over all registers without caring about those which don’t get used in the code. This useful propertyis given below:
