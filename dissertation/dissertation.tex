...
\begin{alltt}\small
	\HOLConst{lowest_degree_subgraph_heuristic_aux} \HOLFreeVar{done} [] \HOLFreeVar{cs\sp{\prime}} = \HOLConst{REVERSE} \HOLFreeVar{cs\sp{\prime}}
\HOLConst{lowest_degree_subgraph_heuristic_aux} \HOLFreeVar{done} ((\HOLFreeVar{r},\HOLFreeVar{rs})::\HOLFreeVar{cs}) \HOLFreeVar{cs\sp{\prime}} =
(\HOLKeyword{let} \HOLBoundVar{sorted} = \HOLConst{sort_not_considered_by_degree} (\HOLFreeVar{r} INSERT \HOLFreeVar{done}) \HOLFreeVar{cs}
 \HOLKeyword{in}
   \HOLConst{lowest_degree_subgraph_heuristic_aux} (\HOLFreeVar{r} INSERT \HOLFreeVar{done}) \HOLBoundVar{sorted}
...
\begin{alltt}\small
	\HOLConst{lowest_degree_subgraph_heuristic} \HOLFreeVar{cs} =
\HOLConst{lowest_degree_subgraph_heuristic_aux} (\HOLTokenLambda{}\HOLBoundVar{x}. \HOLConst{F})
...
\begin{alltt}\small
   ...
   \HOLConst{MEM} \HOLFreeVar{x} (\HOLConst{lowest_degree_subgraph_heuristic_aux} \HOLFreeVar{done} \HOLFreeVar{list} \HOLFreeVar{acc})
\end{alltt}
