...
that no two adjacent vertices share the same colour (\cite{wolframGraphColouring}). Given the knowledge of which
...
and so finding a truly optimal solution is rarely feasible in practice (as discussed in \cite{graphColouringComplexity}). Instead,
...
\section{Naive graph colouring} \label{sec:naiveColouring}
